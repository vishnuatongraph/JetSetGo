...
function App() {
  ...
  return (
    <NativeBaseProvider>
      <NavigationContainer>
      <Context.Provider value={{ flights, setFlights, selectedDestination, selectedSource, setSelectedDestination, setSelectedSource, searchedFlights, setSearchedFlights }}>
        <Stack.Navigator>
